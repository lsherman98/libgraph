		...
		jsonData := `[
			...
			},
			{
				...
				"fields": [
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_39049810",
						"hidden": false,
						"id": "relation3458754147",
						"maxSelect": 1,
						"minSelect": 0,
						"name": "summary",
						"presentable": false,
				...
				"id": "pbc_3446931122",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_Bop50bwNCz` + "`" + ` ON ` + "`" + `pages` + "`" + ` (\n  ` + "`" + `upload` + "`" + `,\n  ` + "`" + `page` + "`" + `\n)"
				],
				"listRule": "@request.auth.id = user.id",
				"name": "pages",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_3301151734",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_Vzwl7mew3r` + "`" + ` ON ` + "`" + `highlights` + "`" + ` (` + "`" + `upload` + "`" + `)"
				],
				"listRule": "@request.auth.id = user.id",
				"name": "highlights",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_486090712",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_tVc6aL6mAV` + "`" + ` ON ` + "`" + `bookmarks` + "`" + ` (` + "`" + `upload` + "`" + `)"
				],
				"listRule": "@request.auth.id = user.id",
				"name": "bookmarks",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_3395098727",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_zjvtufw4u5` + "`" + ` ON ` + "`" + `notes` + "`" + ` (` + "`" + `upload` + "`" + `)"
				],
				"listRule": "@request.auth.id = user.id",
				"name": "notes",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_2605467279",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_trDZJh04XE` + "`" + ` ON ` + "`" + `messages` + "`" + ` (\n  ` + "`" + `chat` + "`" + `,\n  ` + "`" + `created` + "`" + `\n)"
				],
				"listRule": "@request.auth.id = user.id",
				"name": "messages",
				"system": false,
			...
			},
			{
				...
				"indexes": [
					...
					"CREATE INDEX ` + "`" + `idx_m2TCCglP4R` + "`" + ` ON ` + "`" + `document_chunks` + "`" + ` (` + "`" + `vector_id` + "`" + `)"
				],
				"listRule": "@request.auth.id = user.id",
			...
			},
			{
				...
				"id": "pbc_1788416371",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_42FJMQWOrN` + "`" + ` ON ` + "`" + `reading_progress` + "`" + ` (\n  ` + "`" + `user` + "`" + `,\n  ` + "`" + `upload` + "`" + `\n)"
				],
				"listRule": "@request.auth.id = user.id",
			...
			},
			{
				...
				"id": "pbc_2956699289",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_0qKKx73CoW` + "`" + ` ON ` + "`" + `embedding_jobs` + "`" + ` (` + "`" + `batch_id` + "`" + `) WHERE ` + "`" + `batch_id` + "`" + ` IS NOT NULL AND ` + "`" + `batch_id` + "`" + ` != ''"
				],
				"listRule": null,
				"name": "embedding_jobs",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_1900487924",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_4WBwBx6gCL` + "`" + ` ON ` + "`" + `chat_contexts` + "`" + ` (` + "`" + `chat` + "`" + `)"
				],
				"listRule": "@request.auth.id = user.id",
				"name": "chat_contexts",
				"system": false,
