...
import { X, Plus, Columns2, Square } from "lucide-react";
...
interface ReaderTabBarProps {
  onAddTab?: () => void;
  className?: string;
}

export function ReaderTabBar({ onAddTab, className }: ReaderTabBarProps) {
  const { tabs, activeTabId, splitMode, splitTabId, setActiveTab, removeTab, setSplitMode, closeSplit } =
    useReaderTabsStore();
